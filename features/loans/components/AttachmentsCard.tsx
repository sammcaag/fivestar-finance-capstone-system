  ...
  return (
    <Card className="border shadow-sm hover:shadow-md transition-shadow">
      <CardHeader className="w-full h-32 bg-gray-100 rounded-md flex items-center justify-center mb-3">
        {attachment.type === "pdf" && <FileText className="h-12 w-12 text-destructive" />}
        {attachment.type === "image" && <ImageIcon className="h-12 w-12 text-blue-500" />}
        {attachment.type === "doc" && <File className="h-12 w-12 text-blue-700" />}
      </CardHeader>
