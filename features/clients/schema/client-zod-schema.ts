...
export const clientFamilyInfoSchema = z.object({
  ...
  spouseAddressLine1: createOptionalStringField("Spouse Address Line 1", 4, 150),
  spouseAddressLine2: createOptionalStringField("Spouse Address Line 2", 4, 150),
  spouseBarangay: createOptionalStringField("Spouse Barangay", 4, 150),
  spouseCityOrMunicipality: createOptionalStringField("Spouse City or Municipality", 4, 150),
  ...
  firstChildAddressLine1: createOptionalStringField("First Child Address Line 1", 4, 150),
  firstChildAddressLine2: createOptionalStringField("First Child Address Line 2", 4, 150),
  firstChildBarangay: createOptionalStringField("First Child Barangay", 4, 150),
  firstChildCityOrMunicipality: createOptionalStringField(
    "First Child City or Municipality",
    4,
    150
  ),
  ...
  secondChildAddressLine1: createOptionalStringField("Second Child Address Line 1", 4, 150),
  secondChildAddressLine2: createOptionalStringField("Second Child Address Line 2", 4, 150),
  secondChildBarangay: createOptionalStringField("Second Child Barangay", 4, 150),
  secondChildCityOrMunicipality: createOptionalStringField(
    "Second Child City or Municipality",
    4,
    150
  ),
  secondChildProvince: createOptionalStringField("Second Child Province", 4, 150),
  ...
  thirdChildAddressLine1: createOptionalStringField("Third Child Address Line 1", 4, 150),
  thirdChildAddressLine2: createOptionalStringField("Third Child Address Line 2", 4, 150),
  thirdChildBarangay: createOptionalStringField("Third Child Barangay", 4, 150),
  thirdChildCityOrMunicipality: createOptionalStringField(
    "Third Child City or Municipality",
    4,
    150
  ),
