...
export default function RegisterBranch() {
  useEffect(() => {
    document.title = "Register Branch | Stella - Five Star Finance Inc.";
  }, []);
  ...
  return (
    <ContentLayout title="Register Branch">
      <BreadcrumbPages
        links={[
      ...
      <MainHeader
        ...
        description="Easily onboard branch by filling in the fields with their exact information."
      />
