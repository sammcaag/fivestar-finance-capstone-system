...
export default function ClientInfoPage() {
  useEffect(() => {
    document.title = "Client Deceased | Stella - Five Star Finance Inc.";
  }, []);
  ...
  const canAddLoan = clientData?.approvalStatus?.toUpperCase() === "APPROVED";
      ...
      {isLoading ? (
        ...
        <>
          ...
          <LoanHistoryTabs
            ...
            isDeceased={clientData.approvalStatus?.toUpperCase() === "DECEASED"}
          />
